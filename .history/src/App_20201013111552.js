...
const App = () => {
  ...
  return (
    ...
    <div className="container">
      <Header />
      <Search handleSubmit={handleSubmit} queryTitle={queryTitle} queryAuthot={queryAuthor} queryPublisher={queryPublisher} handleChangeTitle={handleChangeTitle} handleChangeAuthor={handleChangeAuthor} handleChangePublisher={handleChangePublisher} />
